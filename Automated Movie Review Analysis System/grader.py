...
training error become more smaller, but validation won't change
"""
...
# TODO: Note: Using the extractCharacterFeatures function will cause the code to run slower and
#  result in a smaller training error compared to before.However, the validation error will not
#  be reduced, potentially leading to overfitting issues.
############################################################
